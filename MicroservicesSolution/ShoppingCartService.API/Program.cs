...
using ShoppingCartService.API.Mappings;
using ShoppingCartService.API.Service;
...
builder.Services.AddDbContext<AppShoppingCartDbContext>(option =>
{
...
builder.Services.AddSwaggerGen(option =>
{
    ...
    {
        Name = "Authorization",
        Description = "Enter the Bearer Authorization string as following: 'Bearer Genertated-JWT-Token'",
